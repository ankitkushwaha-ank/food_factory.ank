...
class Cart(models.Model):
    item_title = models.CharField(max_length=50, null=True, default=None, blank=True)
    item_price = models.IntegerField(null=True, default=None)
    item_rating = models.CharField(max_length=20, null=True, default="100", blank=True)
    item_image = models.FileField(upload_to='food/', max_length=250, null=True, default=None)
    item_quantity = models.PositiveIntegerField(null=True, default=1)
