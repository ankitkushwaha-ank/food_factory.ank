...
class WebUsers(models.Model):
    ...
    email_id = models.EmailField(max_length=35, null=False, blank=True,default=None)
    mob_no = models.CharField(max_length=12, null=True, blank=True)
    user_image = models.FileField(upload_to='user/', max_length=250, null=True, default=None)
